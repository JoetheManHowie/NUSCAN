...
public:
	...
	void initializeGraph(string eta, string epsilon, string mu);

	void localCluster(string eta_s, string epsilon_s, string mu_s);
	...
	*/
	double computeSim(int u, int v_index);

	//double computeSim(int u, int v_index, double epsilon); // epsilon is the similarity threshold 

	double computeSim(int u, int v_index, double epsilon, double eta);

	double computeub(int u, int v_index, double epsilon);
